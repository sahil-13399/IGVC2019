...
if("TRUE" STREQUAL "TRUE")
  set(chefbot_bringup_SOURCE_PREFIX /home/sahil/catkin_ws/src/chefbot_bringup)
  set(chefbot_bringup_DEVEL_PREFIX /home/sahil/catkin_ws/devel_isolated/chefbot_bringup)
  ...
  set(chefbot_bringup_INSTALL_PREFIX /home/sahil/catkin_ws/install_isolated)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'chefbot_bringup' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'chefbot_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sahil/catkin_ws/src/chefbot_bringup/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sahil/catkin_ws/devel_isolated/chefbot_bringup/lib;/home/sahil/catkin_ws/devel_isolated/autoz/lib;/home/sahil/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
